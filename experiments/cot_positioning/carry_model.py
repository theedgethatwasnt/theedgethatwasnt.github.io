...
# Copied from research/experiments/multiday_contrarian/carry_model.py (2026-07-07) for
# cot_positioning, then EXTENDED: financing_snapshot_2026-07-07.json adds USD_CAD/USD_CHF
# (pulled one day later than the original 12-pair snapshot; negligible rate drift,
# documented per R9) because this experiment needs a direct CAD/CHF-vs-USD leg that
# multiday_contrarian's pair set didn't require. See carry_splice.py for the additional
# pre-2020 flat-FRED-differential splice this experiment's pre-registration calls for.
SNAPSHOT_PATH = os.path.join(HERE, "financing_snapshot_2026-07-07.json")
