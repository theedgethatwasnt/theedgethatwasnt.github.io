...
# Sweep grids
N_SMALLS       = [1, 2]
SMA_M5S        = [7, 12, 24, 50, 84]    # ~35min, 1h, 2h, 4h, 7h
SMA_H1S        = [7, 14, 50]            # 7h, 14h, ~2-day regime
H1_TREND_BARS  = 5
...
def main():
    warmup_jit()
    print("H1+M5 MTF v5 — wider SMA mix (SMA7+SMA50 on both TFs)")
